...
public class trayController : MonoBehaviour
{
    ...
    [SerializeField] MeatCutterHuman humanCut;
    ...
    private void trayPickup(int tray)
    {
        switch (tray)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                humanCut.trayBox.SetActive(false);
                humanCut.chuck.SetActive(false);
                humanCut.shoulder.SetActive(false);
                humanCut.rib.SetActive(false);
                humanCut.abdomen.SetActive(false);
                humanCut.butt.SetActive(false);
                humanCut.round.SetActive(false);
                humanCut.shank.SetActive(false);
                break;
